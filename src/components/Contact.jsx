...
const Contact = () => {
  const socialLinks = [
    {
      href: "https://www.github.com/raees-aziz",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      href: "https://www.linkedin.com/in/raees-aziz-9562572a5",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      href: "https://www.instagram.com/ig__venom6",
      icon: (
        <svg
          width="25"
          height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        {/* form */}
        <form method="POST" className="xl:pl-10 2xl:pl-20" action="https://getform.io/f/bejezxla">
